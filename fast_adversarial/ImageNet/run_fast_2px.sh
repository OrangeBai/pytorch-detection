...
CONFIG1=yml/configs_fast_phase1_${NAME}.yml
...
python -u main_fast.py -c $CONFIG1 --output_prefix $PREFIX1 | tee $OUT1
...
python -u main_fast.py -c $CONFIG2 --output_prefix $PREFIX2 --resume $END1 | tee $OUT2
...
python -u main_fast.py -c $CONFIG3 --output_prefix $PREFIX3 --resume $END2 | tee $OUT3
